...
export type TreasurySidebarProps = Omit<
...
const TreasurySidebar = React.forwardRef<HTMLElement, TreasurySidebarProps>(
  (
    {
      items,
      isCompact,
...
TreasurySidebar.displayName = "Treasury Sidebar";
